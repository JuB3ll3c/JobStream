...
class JobControllerTest {
    ...
    @Test
    void getJobs_shouldDefaultToFirstPageSortedByCreatedAtDesc() throws Exception {
        when(jobService.getJobs(any(Pageable.class)))
        ...
        verify(jobService).getJobs(captor.capture());
